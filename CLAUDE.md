...
3. Ask if we are creating a new feature or fixing a bug.
4. Ask for an example scenario (this can be a file or a description).
5. Suggest a list of test scenarios (titles only) to cover. Confirm with the user.
6. Create the JUnit test file (or confirm the file in use). Validate the name and location.
7. Ask your pair to confirm the scenario we want to work on
8. Always work on one test at a time
9. Validate the tests with the user.
